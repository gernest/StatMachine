...
func TestBiggestWin(t *testing.T) {
	allResults := []Result{
		...
		Result{1, 0, 4, 0, 0, 0, false, 0, time.Now(), 1},
		Result{2, 0, 0, 3, 0, 0, true, 0, time.Now(), 1},
		Result{3, 0, 1, 1, 0, 0, false, 0, time.Now(), 1},
		Result{4, 0, 5, 2, 0, 0, false, 0, time.Now(), 1},
...
func TestBiggestWinIfNoWin(t *testing.T) {
	allResults := []Result{
		...
		Result{1, 0, 0, 0, 0, 0, false, 0, time.Now(), 1},
		Result{2, 0, 0, 3, 0, 0, true, 0, time.Now(), 1},
		Result{3, 0, 1, 1, 0, 0, false, 0, time.Now(), 1},
		Result{4, 0, 0, 2, 0, 0, false, 0, time.Now(), 1},
		Result{5, 0, 1, 1, 0, 0, true, 0, time.Now(), 1},
	}
...
func TestBiggestWinIfMultiple(t *testing.T) {
	allResults := []Result{
		...
		Result{3, 0, 4, 1, 0, 0, false, 0, time.Now(), 1},
		Result{4, 0, 0, 0, 0, 0, false, 0, time.Now(), 1},
		Result{5, 0, 3, 0, 1, 0, true, 0, time.Now(), 1},
	}
...
func TestBiggestLossesIfMultiple(t *testing.T) {
	allResults := []Result{
		...
		Result{1, 0, 0, 1, 0, 0, false, 0, time.Now(), 1},
		Result{2, 0, 0, 2, 0, 0, true, 0, time.Now(), 1},
		Result{3, 0, 1, 3, 0, 0, false, 0, time.Now(), 1},
		Result{4, 0, 0, 0, 0, 0, false, 0, time.Now(), 1},
...
func TestBiggestScoringResultsIfMultiple(t *testing.T) {
	allResults := []Result{
		Result{0, 0, 1, 0, 0, 0, true, 0, time.Now(), 1},
		Result{1, 0, 4, 0, 0, 0, false, 0, time.Now(), 1},
		Result{2, 0, 2, 2, 0, 0, true, 0, time.Now(), 1},
		Result{3, 0, 3, 1, 0, 0, false, 0, time.Now(), 1},
		Result{4, 0, 1, 3, 0, 0, false, 0, time.Now(), 1},
		Result{5, 0, 1, 1, 0, 0, true, 0, time.Now(), 1},
	}
